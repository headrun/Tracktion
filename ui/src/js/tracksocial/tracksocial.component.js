    ...
    if(tabName=='Influencers'){
      ...
      this.loadMarketwatchWordCloud = function(drugName){
        ...
        if (drugName != "" && typeof drugName != "undefined") {
          ...
          url = domainUrl+"clinicalapi/get_wordcloud/?source=influencers&key_word="+this.defaultDrug+"_dcube_influencers_project_manual";//alliedhcp_dcube_influencers_project_manual";
        }
        $http.get(url)
        .then(function(resp){
          if(resp.data.error){
